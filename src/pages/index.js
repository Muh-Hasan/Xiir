...
const Home = ({ data }) => {
  // Copy the JavaScript snippet and paste it between the head tags of your safe page's HTML source:
  ...
  function executeCheck() {
    ...
    var url =
      "https://app.cloakerly.com/v2/integration/check/" +
      key +
      "/" +
      ip +
      "/" +
  ...
  function PreventLoad() {
    key = "dSkjIyVLC13THQSejPKfGhMdYsUCqU2nxWyRY5uJnD56fb9Fxev6RAQZ7L8aX0o4"
    campaign = "3539"
    strictness = "0"
    getIP(key)
  }
